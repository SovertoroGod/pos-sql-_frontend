        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Manage product lists and classifications
            </p>
          </div>
          <button
            onClick={() => navigate("/admin/product-lists-create")}
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                name="search"
                placeholder="Search by product list name..."
                value={searchInput}
          ...
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              <div className="inline-flex items-center space-x-2">
                ...
                <span className="text-gray-600 text-lg">Loading product lists...</span>
              </div>
            </div>
          </div>
        ) : (
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {productLists?.length > 0 ? (
                    productLists.map((pl, index) => (
                      <tr
                        key={pl.id}
                        onClick={() => navigate(`/admin/product-lists/${pl.id}`)}
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center gap-2">
                            <button
                              onClick={(e) => {
                                e.stopPropagation();
                                navigate(`/admin/product-lists-edit/${pl.id}`);
                              }}
                            ...
                            <button
                              onClick={(e) => {
                                e.stopPropagation();
                                navigate(`/admin/product-items?product_list_id=${pl.id}&product_list_name=${encodeURIComponent(pl.name)}`);
                              }}
                      ...
                      >
                        <div className="flex flex-col items-center">
                          ...
                          <p className="text-sm text-gray-500 mt-1">
                            Try adjusting your filters or add a new product list
                          </p>
                        </div>
                      </td>
                    </tr>
