...
const ManagerCreateStockTransferPage = () => {
  ...
  const [form, setForm] = useState({
    product_item_id: "",
    from_branch_id: user?.branch_id ? String(user.branch_id) : "",
    to_branch_id: "",
    quantity: "",
    notes: "",
  });
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Transfer stock from your branch to another branch
              </p>
            </div>
          </div>
        </div>
...
export default ManagerCreateStockTransferPage;
