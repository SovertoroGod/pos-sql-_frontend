...
const UserDetailPage = () => {
  ...
  const { selectedUser, isLoading } = useUserDetail(id);
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">{selectedUser.full_name || 'N/A'}</h1>
                <p className="text-gray-600">@{selectedUser.username}</p>
                <div className="mt-2">
                  <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getRoleBadgeColor(selectedUser.role)}`}>
            ...
            <div className="flex items-center gap-2">
              <button className="inline-flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-200" onClick={()=>navigate(`/admin/users-edit/${selectedUser.id}`)}>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex justify-between items-center py-3 border-b border-gray-100">
                ...
                <span className="text-sm text-gray-900">{selectedUser.full_name || 'N/A'}</span>
              </div>
              <div className="flex justify-between items-center py-3 border-b border-gray-100">
                <span className="text-sm font-medium text-gray-500">Username</span>
                <span className="text-sm text-gray-900 font-mono">@{selectedUser.username}</span>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex justify-between items-center py-3">
                ...
                <span className="text-sm text-gray-900">{selectedUser.branch_id || 'N/A'}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-6">
              <div className="space-y-3">
                <button className="w-full inline-flex items-center justify-center gap-2 bg-blue-600 text-white px-4 py-3 rounded-lg hover:bg-blue-700 transition-colors duration-200">
                  <Edit className="h-4 w-4" />
                  Edit User Profile
                </button>
