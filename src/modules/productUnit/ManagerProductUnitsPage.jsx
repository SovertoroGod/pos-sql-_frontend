...
import useManagerProductUnits from "../../hooks/useManagerProductUnits";

const ManagerProductUnitsPage = () => {
  const {
    productUnits,
    metadata,
    isLoading,
      ...
      <div className="mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            View product units in your branch
          </p>
        </div>
      </div>
...
export default ManagerProductUnitsPage;
