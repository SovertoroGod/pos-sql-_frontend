...
const useManagerBankAccountHistory = (id, filters) => {
  ...
  const fetchHistory = useCallback(async () => {
    ...
    setIsLoading(true);
    try {
      const res = await bankAccountServices.getBankAccountHistoryForManager(id, filters);
...
export default useManagerBankAccountHistory;
